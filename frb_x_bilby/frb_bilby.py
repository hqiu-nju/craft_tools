...
def scat_multiband(t,t0,tau1,a1,a2,a3,a4,a5,a6,a7,a8,dmerr,sigi):
...
def d_gaussian(t,t1,t2,dmerr,sigi,sigi2,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8):
    amp_list=np.array([a1,a2,a3,a4,a5,a6,a7,a8])
...
def scat_smear(t,t0,tau1,a1,a2,a3,a4,a5,a6,a7,a8,dmerr,sigi):
    amp_list=np.array([a1,a2,a3,a4,a5,a6,a7,a8])
    alpha=4
    model=[]
    sigma=sigi
...
def dgaus_smear(t,t1,t2,dmerr,sigi,sigi2,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8):
    amp_list=np.array([a1,a2,a3,a4,a5,a6,a7,a8])
    b_list=np.array([b1,b2,b3,b4,b5,b6,b7,b8])
    model=[]
    sigma=sigi
